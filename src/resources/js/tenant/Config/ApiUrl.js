...
export const APP_SETTINGS = `${TENANT_BASE_URL}app/settings`;
...
export const EXPORT_MODULES = `${TENANT_BASE_URL}app/export/module`;
export const EXPORT_FILE_DOWNLOAD = `${TENANT_BASE_URL}app/export/download-file`;

//storage setting
export const STORAGE_SETTING = "admin/app/storage-configuration";
...
export const BREAK_TIME = `${TENANT_BASE_URL}/app/break-time`;
export const SELECTABLE_BREAK_TIMES = `${TENANT_BASE_URL}selectable/break-times`;
