...
Vue.component(
  "app-pre-loader",
  require("./components/preloders/Preloader").default
);
Vue.component(
  "app-overlay-loader",
  require("./components/preloders/OverlayLoader").default
);
...
Vue.component(
  "app-load-more",
  require("./components/buttons/LoadMore").default
);
Vue.component(
  "app-pagination",
  require("./components/buttons/Pagination").default
);
...
Vue.component(
  "app-tab-filter",
  require("./components/filter/TabFilter").default
);
...
Vue.component(
  "app-avatars-group",
  require("./components/avatars-group/AvatarsGroup").default
);
Vue.component("app-tab", require("./components/tabs/Index").default);
Vue.component(
  "app-custom-tab",
  require("./components/custom-tabs/Index").default
);
Vue.component(
  "app-form-wizard",
  require("./components/form-wizard/FormWizard").default
);
Vue.component("app-button", require("./components/buttons/AppButton").default);
Vue.component(
  "app-breadcrumb",
  require("./components/breadcrumb/index").default
);
...
Vue.component(
  ...
  require("./components/template-preview-card/AppTemplatePreviewCard").default
);
...
Vue.component(
  "app-dropdown-menu",
  require("./components/buttons/DropdownMenu").default
);
Vue.component("app-navbar", require("./components/layouts/Navbar").default);
Vue.component(
  "app-navbar-language-dropdown",
  require("./components/layouts/navbar-dropdowns/LanguageDropdown").default
);
Vue.component(
  "app-navbar-notification-dropdown",
  require("./components/layouts/navbar-dropdowns/NotificationDropdown").default
);
Vue.component(
  "app-navbar-profile-dropdown",
  require("./components/layouts/navbar-dropdowns/ProfileDropdown").default
);
Vue.component(
  "app-widget",
  require("./components/dashboard-widget/Index").default
);
Vue.component(
  "app-confirmation-modal",
  require("./components/confirmation-modal/Index").default
);
Vue.component(
  "app-empty-data-block",
  require("./components/datatable/EmptyData").default
);
Vue.component(
  "app-media-object",
  require("./components/media-object/MediaObject").default
);
Vue.component("app-error", require("./components/error-page/Error").default);
Vue.component(
  "app-calendar",
  require("./components/calendar/Calendar").default
);
Vue.component(
  "app-filter-with-search",
  require("./components/filter/FilterWithSearch").default
);
Vue.component(
  "app-submit-button",
  require("./components/buttons/SubmitButton").default
);
Vue.component(
  "app-organization-chart",
  require("./components/organization-chart/OrganizationChart").default
);
Vue.component(
  "app-tag-manager",
  require("./components/tag/TagManager").default
);
