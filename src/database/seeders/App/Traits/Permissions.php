...
trait Permissions
{
    public function permissions($tenant, $app): array
    {
        return [
            ...
            [
                'name' => 'view_employee_bank_details',
                'type_id' => $tenant,
                'group_name' => 'employees'
            ],
            [
                'name' => 'create_employee_bank_details',
                'type_id' => $tenant,
                'group_name' => 'employees'
            ],
            [
                'name' => 'update_employee_bank_details',
                'type_id' => $tenant,
                'group_name' => 'employees'
            ],
            [
                'name' => 'delete_employee_bank_details',
                'type_id' => $tenant,
                'group_name' => 'employees'
            ],
            [
            ...
            [
                'name' => 'export_all_attendance_summery',
                'type_id' => $tenant,
                'group_name' => 'export'
            ],
            [
