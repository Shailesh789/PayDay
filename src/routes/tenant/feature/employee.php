...
use App\Http\Controllers\Tenant\Employee\EmployeeBankDetailController;
...
Route::group(['prefix' => 'app'], function (Router $router) {
    ...
    $router->group(['prefix' => 'employees/{employee}'], function (Router $router) {
        ...
        $router->apiResource('bank-details', EmployeeBankDetailController::class, [
            'names' => [
                'store' => 'employee-bank-details.store',
                'destroy' => 'employee-bank-details.destroy',
                'update' => 'employee-bank-details.update',
                'show' => 'employee-bank-details.show'
            ]
        ])->except('index');
    });
