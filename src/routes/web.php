...
Route::any('dispatch-job', [InstallDemoDataController::class, 'runJobs'])
    ->name('dispatch-job');
...
Route::get("/terms-and-condition", fn () => view('terms-of-use'));

Route::get('/schedule-work', function () {

    \Illuminate\Support\Facades\Artisan::call('queue:work --queue=high,default --tries=2 --stop-when-empty');
